      ...
      <div className="flex flex-col lg:flex-row w-full lg:justify-between lg:items-center">
        <div className="flex items-center justify-between">
          <Link href={"/"} className="flex items-center gap-3">
            <Image src={"/icon.svg"} className="w-10 sm:w-16" width={30} height={32} alt="Logo" />
        ...
        >
          <Link href={"#about"} className="font-semibold text-xs sm:text-sm">
            ABOUT
          </Link>
          <Link href={"#tech-stack"} className="font-semibold text-xs sm:text-sm">
            TECH STACK
          </Link>
          <Link href={"#recent-work"} className="font-semibold text-xs sm:text-sm">
            RECENT WORK
          </Link>
          <Link href={"#experience"} className="font-semibold text-xs sm:text-sm">
            EXPERIENCE
          </Link>
